...
CoffeesModule = __decorate([
    common_1.Module({ imports: [
        ...
        controllers: [coffees_controller_1.CoffeesController], providers: [coffees_service_1.CoffeesService,
            CoffeeBrandsFactory, { provide: coffees_constants_1.COFFEE_BRANDS, useFactory: async (con) => {
                    const coffeeBrands = await Promise.resolve(['buddy brew', 'nescafe']);
                    console.log('[!] Async factory!');
                    return coffeeBrands;
                }, inject: [CoffeeBrandsFactory, typeorm_2.Connection],
                scope: common_1.Scope.TRANSIENT, }], exports: [coffees_service_1.CoffeesService] })
], CoffeesModule);
